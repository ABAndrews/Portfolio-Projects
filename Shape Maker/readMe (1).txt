...
If the user enters 2, the "twoside" method will be called and it will create grass blades in the shape of a butterfly
...
If the user enters 4, the "fourside" method will be called and the user will be presented with choosing between options 1 or . 
...
If the user enters 7, the "sevenside" method will be called and it will create a 7 sided auspicious midieval coin
...
Once one of the functions are called and compeleted, the menu exits and closes, and the user will have to run the program again to run the other methods.
